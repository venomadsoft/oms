...
class AuditresourceApi(object):
    ...
    def get_all_using_get(self, **kwargs):
        """
        getAll
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_all_using_get(callback=callback_function)
        ...
        resource_path = '/api/audits'.replace('{format}', 'json')
        method = 'GET'
    ...
    def get_using_get(self, id, **kwargs):
        ...
        resource_path = '/api/audits/{id}'.replace('{format}', 'json')
        method = 'GET'
